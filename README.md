...
This is a sample template for slack-bot - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name slack-bot --tail
```
...
```bash
aws cloudformation delete-stack --stack-name slack-bot
```
